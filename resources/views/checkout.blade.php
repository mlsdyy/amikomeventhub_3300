        ...
        <div class="grid grid-cols-1 gap-8">
            <div class="bg-white rounded-3xl border border-slate-200 p-8 shadow-sm">
                ...
                <div class="flex gap-6 items-start">
                    ...
                    <div>
                        <h4 class="font-extrabold text-lg text-slate-800">Jazz Night 2024: A Celebration</h4>
                        <p class="text-slate-500 text-sm font-medium">16 Nov 2024 • The Blue Note Lounge</p>
                        <p class="text-indigo-600 font-black mt-2">1 x Rp 150.000</p>
                    </div>
                </div>
                <div class="mt-8 pt-6 border-t space-y-3">
                    ...
                    <div class="flex justify-between text-2xl font-black mt-4 pt-4 border-t text-slate-900">
                        ...
                        <span class="text-indigo-600 tracking-tighter">Rp 155.000</span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-3xl border border-slate-200 p-8 shadow-sm">
                ...
                <form class="space-y-6">
                    <div>
                        <label class="block text-sm font-bold text-slate-700 mb-2 uppercase tracking-widest text-[10px]">Nama Lengkap</label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label class="block text-sm font-bold text-slate-700 mb-2 uppercase tracking-widest text-[10px]">Email Aktif</label>
                        ...
                        <div>
                            <label class="block text-sm font-bold text-slate-700 mb-2 uppercase tracking-widest text-[10px]">No. WhatsApp</label>
                    ...
                    <button type="button" onclick="showMidtrans()"
                        class="w-full py-5 bg-indigo-600 text-white rounded-2xl font-black text-xl shadow-xl shadow-indigo-200 hover:bg-indigo-700 active:scale-95 transition-all uppercase tracking-tight">
                        Bayar Sekarang
                    </button>
                    <p class="text-center text-[10px] text-slate-400 font-bold uppercase tracking-widest">Aman & Terverifikasi oleh AmikomEventHub</p>
                </form>
            </div>
    ...
    <div id="midtrans-overlay"
        ...
        <div class="bg-white w-full max-w-sm rounded-[2.5rem] overflow-hidden shadow-2xl animate-bounce-in">
            <div class="bg-slate-50 p-6 flex justify-between items-center border-b">
                <img src="https://midtrans.com/assets/img/logo-dark.png" alt="Midtrans Logo" class="h-5">
                <button onclick="hideMidtrans()" class="p-2 hover:bg-slate-200 rounded-full transition-colors">
            ...
            <div class="p-8 text-center">
                <p class="text-slate-500 font-bold uppercase text-[10px] tracking-widest">Total Tagihan</p>
                <h2 class="text-3xl font-black text-indigo-700 my-2 tracking-tighter">Rp 155.000</h2>
                ...
                <div
                    class="mt-12 flex items-center justify-center gap-2 text-[10px] text-slate-400 font-bold uppercase tracking-[0.2em]">
