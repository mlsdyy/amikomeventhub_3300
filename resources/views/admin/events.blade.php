    ...
    <aside class="w-64 bg-indigo-900 text-indigo-100 flex flex-col p-6 space-y-8 sticky top-0 h-screen">
        ...
        <nav class="flex-1 space-y-2">
            ...
            <a href="{{ route('admin.events.index') }}"
                class="flex items-center gap-3 px-4 py-3 {{ request()->routeIs('admin.events.index') ? 'bg-indigo-800 text-white' : 'hover:bg-indigo-800' }} rounded-xl font-bold transition">
                <svg class="w-5 h-5 {{ request()->routeIs('admin.events.index') ? 'text-indigo-300' : 'text-indigo-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="{{ route('admin.transactions.index') }}"
                class="flex items-center gap-3 px-4 py-3 {{ request()->routeIs('admin.transactions.index') ? 'bg-indigo-800 text-white' : 'hover:bg-indigo-800' }} rounded-xl font-bold transition">
                    ...
                    <tbody class="divide-y border-t">
                        <tr class="hover:bg-slate-50/50 transition">
                            ...
                            <td class="px-8 py-6">
                                ...
                                <p class="text-xs text-slate-400 font-bold italic">Musik • 16 Nov 2024</p>
                            </td>
                            <td class="px-8 py-6 text-left">
                                <p class="font-bold text-indigo-600">Rp 150.000</p>
                                <p class="text-xs text-slate-400 font-medium tracking-tight">Stok: 42/100</p>
                            </td>
                            <td class="px-8 py-6">
                        ...
                        <tr class="hover:bg-slate-50/50 transition">
                            ...
                            <td class="px-8 py-6">
                                <p class="font-black text-slate-800 uppercase tracking-tight">AI & Future Workshop</p>
                                <p class="text-xs text-slate-400 font-bold italic">Tech • 26 Oct 2024</p>
                            </td>
                            <td class="px-8 py-6 text-left">
                                <p class="font-bold text-indigo-600">Rp 50.000</p>
                                <p class="text-xs text-slate-400 font-medium tracking-tight">Stok: 12/50</p>
                            </td>
                            <td class="px-8 py-6">
                                <div class="flex gap-2">
                                    <button
