...
<body class="bg-slate-50 text-slate-900 flex min-h-screen">
    ...
    <main class="flex-1 p-10 overflow-y-auto">
        <header class="flex justify-between items-center mb-10 text-left">
            <div>
                <h1 class="text-3xl font-black italic">Laporan Transaksi</h1>
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y border-t">
                        <tr class="hover:bg-slate-50/50 transition">
                            ...
                            <td class="px-8 py-6">
                                <p class="font-medium text-slate-700 italic">Jazz Night 2024</p>
                            </td>
                        ...
                        <tr class="hover:bg-slate-50/50 transition text-slate-400">
                            ...
                            <td class="px-8 py-6">
                                <p class="font-bold uppercase">Maya Sari</p>
                                <p class="text-xs">maya@example.com</p>
                            </td>
                            <td class="px-8 py-6">
                                <p class="font-medium italic">AI & Future Workshop</p>
                            </td>
                        ...
                        <tr class="hover:bg-slate-50/50 transition">
                            ...
                            <td class="px-8 py-6">
                                <p class="font-bold text-slate-800 uppercase">Budi Santoso</p>
                                <p class="text-xs text-slate-500">budi@example.com</p>
                            </td>
                            <td class="px-8 py-6">
                                <p class="font-medium text-slate-700 italic">Hackathon 2024</p>
                            </td>
                            <td class="px-8 py-6 text-sm text-slate-500">
                                25 Mar 2024, 10:00
                            </td>
