...
<header class="flex justify-between items-center mb-10 text-left">
    <div>
        <h1 class="text-3xl font-black italic text-indigo-900 underline underline-offset-8">Laporan Transaksi</h1>
        <p class="text-slate-500 font-medium mt-4">Pantau arus kas dan penjualan tiket Anda.</p>
    </div>
