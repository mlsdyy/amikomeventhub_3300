    ...
    <div class="grid grid-cols-1 gap-8">
        <div class="bg-white rounded-3xl border border-slate-200 p-8 shadow-sm">
            ...
            <div class="flex gap-6 items-start">
                ...
                @php
                    // Logika dinamis: Mendukung panggil dari images/ (InfinityFree) maupun storage/ (Lokal & Laravel Cloud)
                ...
                <img src="{{ $imagePath }}" 
                     ...
                     onerror="this.onerror=null; this.src='https://via.placeholder.com/200x200?text=No+Poster';">
